...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden bg-[#0F1A10]"
    >
      {/* Grid background */}
      <div
      ...
      <div
        ref={heroRef}
        className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full"
      >
        {/* ── Left Side ── */}
        <div>
          {/* Tag */}
          <div className="inline-flex items-center gap-2 bg-amber-400/15 border border-amber-400/40 text-amber-400 px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase mb-6">
            ...
            NGO · Sudurpachim Province · Nepal
          </div>

          {/* Heading */}
          <h1 className="font-display text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
            Empowering{" "}
            <em className="not-italic text-amber-400">Communities,</em>
            <br />
            Protecting <em className="not-italic text-amber-400">Rights</em>
          </h1>

          {/* Description */}
          <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-xl">
            CSDS Nepal is a nonprofit development organization rooted in
            Kailali, dedicated to human rights advocacy, anti-trafficking, peace
            building, and community upliftment since 2019.
          </p>
        ...
        <div className="hidden lg:block relative h-120">
          ...
          <div className="absolute top-1/2 -right-4 -translate-y-1/2 bg-[#0F1A10]/90 backdrop-blur-xl border border-green-500/30 rounded-2xl px-5 py-4 z-10 shadow-2xl">
            <p className="text-amber-400 font-display font-black text-2xl">
              2019
            </p>
