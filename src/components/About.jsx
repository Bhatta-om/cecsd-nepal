...
const VMG = [
  {
    icon: "🌟",
    title: "Vision",
    desc: "Sustained peace and a developed society through empowerment of people living in difficult circumstances.",
  },
  {
    icon: "🎯",
    title: "Mission",
    desc: "Ensuring rights of marginalized women and children through advocacy, capacity building, and leadership development.",
  },
  {
    icon: "🏆",
    title: "Goal",
    desc: "Strengthen systems to enable access to formal education, TEVT skills, and combat all forms of discrimination.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div ref={rightRef} className="fade-up">
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-black text-gray-900 leading-tight mb-4">
              A Community-Led{" "}
              <span className="text-green-700">Development</span> Organization
            </h2>
            ...
            <p className="text-gray-500 text-lg leading-relaxed mb-8">
              Founded in 2075 B.S. (2019) by experienced community development
              professionals, CSDS Nepal operates from Dhangadhi, Kailali. We
              champion rights, dignity, and opportunity for the most
              marginalized communities in Sudurpachim Province.
            </p>
